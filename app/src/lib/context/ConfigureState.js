...
var ConfigureState = function () {
  function ConfigureState(context) {
    _classCallCheck(this, ConfigureState);

    this.context = context;
  }

  _createClass(ConfigureState, [{
    key: 'configuration',
...
exports.default = ConfigureState;